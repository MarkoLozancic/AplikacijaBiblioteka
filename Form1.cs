...
namespace LinqXMLDokumenti
{
    public partial class Form1 : Form
    {
        ...
        private void AdjustForm()
        {
         ...
         private void CollapseMenu()
         {
             if (this.panelMenu.Width > 200) //Collapse menu
             {
                 ...
                 foreach (ToolStripMenuItem menuButton in panelMenu.Controls.OfType<ToolStripMenuItem>())
                 {
                     menuButton.Text = "";
        ...
        private void unosNoveKnjigeToolStripMenuItem_Click_1(object sender, EventArgs e)
        {
        ...
        {
            Posudivanje unos_Korisnika = new Posudivanje();
            unos_Korisnika.Show();
        }

        private void vraćanjaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Vracanje unos_Korisnika = new Vracanje();
            unos_Korisnika.Show();
        }
    }
}
